...
export default function ChangePasswordModal({
  ...
  const handleSave = async () => {
    if (!currentPassword || !newPassword || !confirmPassword) {
      Alert.alert("Error", t("password.all_required"));
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        "Error",
        err instanceof Error ? err.message : t("password.error"),
      );
    } finally {
      setSaving(false);
    }
    ...
    <Modal visible transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={styles.card}>
          <Text style={styles.title}>{t("password.change_title")}</Text>
          <Text style={styles.subtitle}>{t("password.change_subtitle")}</Text>
